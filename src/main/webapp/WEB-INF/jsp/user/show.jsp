...
<head>
    ...
    <link rel="stylesheet" href="${path}/static/css/user/Myshow.css">
    ...
    <style>
        ...
        .animal_me .introduce{
            border-bottom: 1px solid rgb(52, 0, 101);
...
<body>
<div class="myDiv">
    <div class="pet_all_info">
        <h2>带它回家吧</h2>
        <div class="pet_slider">
        ...
        <div class="pet_info">
            ...
            <div class="animal">
                <div class="group">
                    <div class="animalX1 info">
                        <!-- <img src="/static/images/adopt/p2.jpg"> -->
                        
                        <p><b>编号:</b>${pet.id}</p>
                    </div>
                    <div class="animalX2 info">
                        <!-- <img src="/static/images/adopt/p3.jpg"> -->
                        
                        <p>
                            <b>生日:</b><fmt:formatDate pattern="yyyy-MM-dd" value="${pet.birthday}"/>
                        </p>
                    </div>

                    <div class="animalX3 info">
                        <!-- <img src="/static/images/adopt/p4.jpg"> -->
                        
                        <p> <b>品种:</b>${pet.petType}</p>
                    </div>
                    <div class="animalX4 info">
                        <!-- <img src="/static/images/adopt/p5.jpg"> -->
    ...
    <div class="my_btn">
        <button class="btn btn-primary btn-lg" id="pet_adopt_modal_btn">领养</button>
        <button class="btn btn-primary btn-lg" id="tianchuan_btn"
                style="float: right;position: relative;left: 150px;bottom: 45px">返回
        </button>
    </div>

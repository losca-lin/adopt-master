            ...
            <div class='collapse navbar-collapse'>
                ...
                <ul>
                    ...
                    <!-- <li class="dropdown">
                        <a href="#">公告 +</a>
                        <ul>
                          <li><a href="teamBlog">公告</a></li>
                          <li><a href="xin">感谢信</a></li>
                        </ul>
                      </li>
                 -->
                    <%-- <li>--%>
                    ...
                    <li>
                        <a href="${path}/user/team">志愿活动</a>
                    </li>
                    <li>
                        <a href="${path}/user/publishPage">发布中心</a>
                    </li>

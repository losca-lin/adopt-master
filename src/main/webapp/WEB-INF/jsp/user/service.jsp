...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .ih-item.circle .img img:hover {
        box-shadow: 4px 4px 4px 4px rgb(112, 95, 112);
      }
      #main {
        margin: -35px auto;
      }
  ...
  <body>
    ...
    <div class="services" id="services">
      <div class="container pet_info">
        ...
        <div class="w3_agile_services_grids"></div>
      </div>
    </div>
    <div class="row">
      <!-- 分页条信息 -->
    ...
    <script type="text/javascript">
      ...
      function build_pets_table(result) {
        ...
        $.each(pets, function (index, pet) {
          var divTd = $("<div></div>").addClass(
            "ih-item circle effect1 agile_services_grid"
          );
          ...
          var imgTd = $("<div></div>")
            ...
            .append(
              $("<img/>")
                ...
                .attr("src", "/static/images/animal/" + spilt(pet.pic))
                .attr("pet-id", pet.id)
            );
          ...
          $("<div></div>")
            .addClass("col-md-4 col-sm-4 col-xs-4 w3_agile_services_grid")

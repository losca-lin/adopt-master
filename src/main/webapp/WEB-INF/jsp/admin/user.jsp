...
template use /images | Settings | /images Templates. --%> <%@ page
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function () {
        ...
        //根据值让option选中
        $("#user_time_zone option[value='" + key + "']").attr(
          "selected",
          "selected"
        );
      });

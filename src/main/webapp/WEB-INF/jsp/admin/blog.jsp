        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button
              ...
              data-dismiss="modal"
              id="blog_saveDown_btn"
            >
              关闭
            </button>
            <button type="button" class="btn btn-primary" id="blog_save_btn">
              提交
            </button>
          </div>
        </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button
              ...
              class="btn btn-default"
              data-dismiss="modal"
              id="blog_updateDown_btn"
            >
              关闭
            </button>
            <button type="button" class="btn btn-primary" id="blog_edit_btn">
              保存修改
            </button>
          </div>
        </div>

...
<script>
    new Vue({
        ...
        methods: {
            ...
            getAll() {
                axios.get('${path}/admin/allEmployee', {
                    params: this.query
                }).then(res => {
                    console.log(res)
            ...
            handleDel(index, row) {
                axios.get("${path}/admin/delEmployee", {
                    params: {id: row.id}
                }).then(res => {
                    this.$message("删除成功");
                    this.getAll()
            ...
            saveEdit() {
                ...
                axios.post("${path}/admin/updateEmployee", data).then(res => {
                    this.$message("修改成功")
                    this.getAll();
            ...
            addEdit() {
                ...
                axios.post("${path}/admin/addEmployee", data).then(res => {
                    this.getAll();

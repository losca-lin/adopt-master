...
<%-- Created by IntelliJ IDEA. Date: 2022/1/22 Time: 14:21 To change this
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button
              ...
              data-dismiss="modal"
              id="admin_saveDown_btn"
            >
              关闭
            </button>
            <button type="button" class="btn btn-primary" id="admin_save_btn">
              创建
            </button>
          </div>
        </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button
              ...
              class="btn btn-default"
              data-dismiss="modal"
              id="admin_updateDown_btn"
            >
              关闭
            </button>
            <button type="button" class="btn btn-primary" id="admin_update_btn">
              保存修改
            </button>
          </div>
        </div>
        ...
        if (currentAdminId == 0) {
          ...
          $.ajax({
            ...
            success: function (result) {
              ...
              $("#edit_pic").attr(
                "src",
                "/static/images/admin/" + result.extend.admin.pic
              );

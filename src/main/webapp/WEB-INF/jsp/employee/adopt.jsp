<%-- Created by IntelliJ IDEA. User: 24255 Date: 2019/8/22 Time: 23:49 To change
      ...
      function build_adopts_table(result) {
        ...
        $.each(adopts, function (index, adopt) {
          ...
          var editBtn = $("<button></button>")
            .addClass("btn btn-primary btn-sm agree_btn")
            .append($("<span></span>").addClass("glyphicon glyphicon-pencil"))
            .append("同意");
          //为编辑按钮添加一个自定义的属性，来表示当前员工id
          editBtn.attr("agree-id", adopt.id);
          var delBtn = $("<button></button>")
            .addClass("btn btn-danger btn-sm disagree_btn")

...
this template use /images | Settings | /images Templates. --%> <%@ page
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" id="pet_save_btn">
              提交宠物信息
            </button>
          </div>
        </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button
              ...
              class="btn btn-default"
              data-dismiss="modal"
              id="pet_updateDown_btn"
            >
              关闭
            </button>
            <button type="button" class="btn btn-primary" id="pet_update_btn">
              保存修改
            </button>
          </div>
        </div>
